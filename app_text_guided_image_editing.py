...
class TiNOEditTextGuidedImageEditingPipeline(StableDiffusionImg2ImgPipeline):
...
def parse_arguments():
    ...
    parser.add_argument(
        "--original_image_path",
        type=str,
        default="examples/1_input.jpg",
        help="path to the original image",
    )
    parser.add_argument(
        "--output_image_path",
        type=str,
        default="examples/1_output.jpg",
...
if __name__ == "__main__":
    ...
    device = "cuda"
    pipe = TiNOEditTextGuidedImageEditingPipeline.from_pretrained(model_id , safety_checker=None, torch_dtype=torch.float16)
